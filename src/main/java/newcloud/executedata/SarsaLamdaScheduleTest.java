...
/**
 * Test harness for the SarsaLamda VM placement strategy.
 */
public class SarsaLamdaScheduleTest {
    ...
    public List<Double> execute() throws Exception {
        for (int i = 0; i < Iteration; i++) {
            ...
            VmAllocationAssignerSarsa_lamda assigner = new VmAllocationAssignerSarsa_lamda(LEARNING_GAMMA, LEARNING_ALPHA, LEARNING_EPSILON, 0.9, GenExcel.getInstance());
            ...
            PowerDatacenterSarsa_lamda datacenter = new PowerDatacenterSarsa_lamda("Datacenter", chars, vmAllocationPolicy, new LinkedList<Storage>(), 300, assigner, brokerId);
