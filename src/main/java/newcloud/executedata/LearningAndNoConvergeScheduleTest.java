...
/**
 * Test harness for the LearningAndNoConverge VM placement strategy.
 */
public class LearningAndNoConvergeScheduleTest {
    ...
    public List<Double> execute() throws Exception {
        for (int i = 0; i < Iteration; i++) {
            ...
            VmAllocationAssignerLearningAndNoConverge assigner = new VmAllocationAssignerLearningAndNoConverge(LEARNING_GAMMA, LEARNING_ALPHA, LEARNING_EPSILON, GenExcel.getInstance());
            ...
            PowerDatacenterLearningAndNoConverge datacenter = new PowerDatacenterLearningAndNoConverge("Datacenter", chars, vmAllocationPolicy, new LinkedList<Storage>(), 300, assigner, brokerId);
