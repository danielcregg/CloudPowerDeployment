...
/**
 * Test harness for the LearningAndInit VM placement strategy.
 */
public class LearningAndInitScheduleTest {
    ...
    public List<Double> execute() throws Exception {
        for (int i = 0; i < Iteration; i++) {
            ...
            VmAllocationAssignerLearningAndInit assigner = new VmAllocationAssignerLearningAndInit(LEARNING_GAMMA, LEARNING_ALPHA, LEARNING_EPSILON, GenExcel.getInstance());
            ...
            PowerDatacenterLearningAndInit datacenter = new PowerDatacenterLearningAndInit("Datacenter", chars, vmAllocationPolicy, new LinkedList<Storage>(), 300, assigner, brokerId);
